  ...
  try {
    ...
    if (action === 'vote') {
      ...
      const existingVote = await query(`
        ...
        WHERE from_team_id = $1 AND to_team_id = $2 AND session_id = $3
      `, [fromTeamId, toTeamId, votingSession.id]);
          ...
          case 'start_pitch':
            ...
            await query(`
              ...
              SET current_presenting_team = $1,
                  ...
                  phase_end_time = $3
              WHERE id = $4
            `, [teamId, now, new Date(now.getTime() + 90000), votingSession.id]);
          ...
          case 'start_voting':
            ...
            await query(`
              ...
              SET phase = 'voting',
                  ...
                  phase_end_time = $2
              WHERE id = $3
            `, [now, new Date(now.getTime() + 30000), votingSession.id]);
